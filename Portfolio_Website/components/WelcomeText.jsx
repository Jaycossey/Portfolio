    ...
    return (
        <>
            ...
            <div id="contact-container" className="col-start-4 col-span-2 row-span-2 mr-10 grid grid-cols-4">
                <p className="text-2xl col-span-4 pt-10 text-right">About me default text, figure it out, or even a short blog post anything that would be about 5-10 lines leading into...</p>
                <p className="text-2xl col-span-4 text-right">Work with me!</p>
                <div id="linkedin-icon" className="w-20 h-20 m-auto col-span-2">Linked</div>
